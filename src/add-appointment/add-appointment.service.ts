...
async findOne(id: string): Promise<AddAppointment | null> {
  ...
  select appointment.id,concat(patients.patient_name," ","(",appointment.patient_id,")") as patient_name,
  concat('APPN','',appointment.id) as appointment_no,
   ...
   appointment.date as appointment_date, appointment.time, patients.mobileno as phone,
